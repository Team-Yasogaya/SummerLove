...
namespace GameDevTV.Core.UI.Dragging
{
        ...
        where T : class
    {
        ...
        protected IDragDestination<T> GetContainer(PointerEventData eventData)
        {
        ...
        protected virtual void DropItemIntoContainer(IDragDestination<T> destination)
        {
        ...
        protected void AttemptSwap(IDragContainer<T> destination, IDragContainer<T> source)
        {
        ...
        protected bool AttemptSimpleTransfer(IDragDestination<T> destination)
        {
